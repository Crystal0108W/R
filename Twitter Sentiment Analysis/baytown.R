...
tweets_classified <- read_csv('/Users/yw7986/Desktop/training.csv',
...
saveRDS(glmnet_classifier, '/Users/yw7986/Desktop/glmnet_classifier.RDS')
#######################################################
...
df_tweets <- twListToDF(searchTwitter('Baytown', n = 1000, lang = 'en')) %>%
  # converting some symbols
  dmap_at('text', conv_fun)
...
ggplot(df_tweets, aes(x = created, y = sentiment, color = sentiment)) +
  ...
  geom_label(data = df_tweets[samp_ind, ],
